...
After running the PSO algorithm, each of the state weights exponents ($q_x$) are given the \Cref{tab:PSO_Weights}. The convergence of two of the exponents over the PSO iterations is shown in \Cref{fig:PSO_Convergence}, while the convergence of the fitness value over the PSO iterations is shown in \Cref{fig:PSO_Fitness}.
